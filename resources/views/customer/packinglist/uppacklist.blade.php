...
<form action="{{ route('packlist.update',$val->id) }}" method="post" id="form1" name="form1">
    {{ csrf_field() }}
    {{method_field('PUT')}}
<table class="" width="90%">
            ...
            <table class="bor-black" width="70%" style="margin-right: 0px;">
                <tr>
                    ...
                    <td style="text-align: center;font-size: 8px;background:#D6DCE4">
                        <input type="date" name="shippingdate" value="{{$val->shippingdate}}"
                ...
                <tr>
                    ...
                    <td style="text-align: center;font-size: 8px;background:#D6DCE4"><input type="text" name="plno" value="PL{{$val->pino}}"
                                 onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}">
                        <input type="hidden" name="orderid" value="{{$val->orderid}}">
    ...
    <table id="test" class="bor-blue tbl" style="width:90%" style="margin: auto">
        ...
        <tr>
            <td><input type="text" name="modelname[]" value="{{$d->modelname}}" style="width:70px;"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></td>
            ...
            <td><input type="text" name="ctns[]" class="ctns" value="{{$d->ctns}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}" required></td>
            <td><input type="text" name="pallets[]"  class="pallets" value="{{$d->pallets}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}" required></td>
            <td><input type="text" name="nw[]"  class="nw" value="{{$d->nw}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}" required></td>
            <td><input type="text" name="gw[]"  class="gw" value="{{$d->gw}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}" required></td>
            <td><input type="text" name="cbm[]"  class="cbm" value="{{$d->cbm}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}" required></td>
        ...
        <tr>
            ...
            <th>
                <input type="text" name="qtytotal" class="qtytotal"  value="{{$val->qtytotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
            <th><input type="text" name="ctnstotal" class="ctnstotal" value="{{$val->ctnstotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
            <th><input type="text" name="palletstotal" class="palletstotal" value="{{$val->palletstotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
            <th><input type="text" name="nwtotal" class="nwtotal" value="{{$val->nwtotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
            <th><input type="text" name="gwtotal" class="gwtotal" value="{{$val->gwtotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
            <th><input type="text" name="cbmtotal" class="cbmtotal" value="{{$val->cbmtotal}}"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}"></th>
        </tr>
        @endforeach
    </table>
