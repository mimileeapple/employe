...
<form action="{{ route('invoice.update',$head->id) }}" method="post" id="form1" name="form1">
    {{ csrf_field() }}
    {{method_field('PUT')}}
<table class="" width="90%">
    ...
    <table class="bor-blue" width="90%">
        ...
        <tr>
            <td>Tax ID</td>
            <td colspan="4" style="text-align: left;padding-left: 50px;"><input type="text" style="width:400px;"  name="taxid" value="{{$head->taxid}}"></td>
        </tr>
        @endforeach
    </table>
    ...
    <table id="test" class="bor-blue tbl" width="90%" style="margin: auto">
        ...
        <tr>
            ...
            <td> <input type="hidden" name="currency[]" value="{{$pay->currency}}">
    ...
    <table class="bor-blue tbl" width="90%" style="margin: auto">
        <tr>
            ...
            <td style="text-align: left;">
                <select name="ourarea">
                    <option value="1" {{$ouraddress=='1'?'selected':""}}>台灣</option>
                    <option value="2" {{$ouraddress=='2'?'selected':""}}>大陸</option>
                </select></td>
        </tr>
    ...
    <br><input type="submit" class="bt-send" value="修改客戶Invoice單"><br><br>
</form>
