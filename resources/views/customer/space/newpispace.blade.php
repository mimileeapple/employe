...
<form action="{{ route('pispace.store') }}" method="post" id="form1" name="form1">
    {{ csrf_field() }}
            ...
            <table class="tbl bor-blue" width="90%" style="text-align: center;" >
                ...
                <tr><td>PI Number</td><td><input type="text" name="pino" value="{{$data->pino}}"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                <td>Date</td>
                    <td><input type="text" name="orderdate" value="{{$data->orderdate}}"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'>
                        <input type="hidden" name="orderid" value="{{$data->id}}"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'>
                    </td></tr>
                @endforeach
                <tr>
                    <td>Model Name</td>
                    <td><input type="text" name="modelname" value="BF24-"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                    <td>System Type</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>Front</td>
                    <td> <input type="text" name="front" value="p"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                </tr>
                <tr><td>*Motherboard</td>
                    <td><input  type="text" name="motherboard" list="motherboard" style="padding: 0.5em; border-radius: 10px"  autocomplete= 'off' />
                        <datalist id="motherboard">
                            <option value="ITX1">ITX1</option>
                            <option value="ITX2">ITX2</option>
                        </datalist></td>
                    <td>BIOS</td>
                    <td><input type="text" name="bios" placeholder="(自填)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                </tr>
                <tr><td>Front IO</td>
                    <td>
                    ...
                    <td>
                        <table id="addbackio">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="backio[]" placeholder="(自填型號)" autocomplete= 'off' style="width:300px;"  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'/>
                ...
                <tr>
                 ...
                 <tr>
                     ...
                     <td>CPU*</td>
                     <td><input type="text" name="cpu" placeholder="(自填型號)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                 </tr>

                <tr>
                    <td>*Key parts</td>
                    <td><input type="text" name="keyparts" placeholder="(自填i3/i5/i7)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                    <td>Memory*</td>
                    <td><input type="text" name="memory" placeholder="(自填型號)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                </tr>
                <tr>
                    <td>SSD/HDD*</td>
                    <td><input type="text" name="ssd" placeholder="(自填型號)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                    <td>Side Function</td>
                    <td>
                        <select id="sidefunction" name="sidefunction">
                            ...
                            <option value="52">HDD Tray	H</option>
               ...
               <tr>
                    <td>Camera FW</td>
                    <td><input  type="text" name="camerafw" placeholder="(自填)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'/></td>
                   <td>Power</td>
                   <td>
                ...
                <tr>
                    <td> Speaker*</td>
                    <td><input type="text" name="speaker" value="2 x 3W Speakers" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                 ...
                 <tr>
                     <td>*Silk Print</td>
                     <td><input type="text" name="silkprint" placeholder="(自填)" autocomplete= 'off'  onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                     <td>Cable Cover</td>
                     <td>
                ...
                <tr>
                   ...
                   <td>
                    ...
                    <td><input type="text" name="kensingtonlock" value="Kensington Lock" autocomplete= 'off' onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'></td>
                </tr>
                <tr>
                    <td>Stand</td>
                    <td>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>*Customer Code</td>
                        <td><input  type="text" name="customercode" placeholder="(自填)" autocomplete= 'off' onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'/></td>
                    </tr>
                    <tr>
                        <td>Customization</td>
                        <td>
                        ...
                        <td>
                            <select id="logo" name="logo">
                                ...
                                <option value="127">silk print only</option>
                                <option value="128">nickel logo only</option>
                                <option value="129">silk print only</option>
                                <option value="130">nickel logo only</option>
                                <option value="131">and Back silk print</option>
                                <option value="132">and Back nickel logo</option>
                                <option value="133">silk print and Back nickel logo</option>
                                <option value="134">nickel logo and Back silk print</option>
                            </select></td>
                    </tr>
                    <tr>
                        <td>Remark*</td>
                        <td><table id="addremark">
                                <tbody>
                                <tr><td><input  type="text" name="remark[]" placeholder="(自填)" autocomplete= 'off' style="width:300px;" onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'/>
                        ...
                        <td>*Version</td>
                        <td><input  type="text" name="version"  placeholder="(自填)" autocomplete= 'off' onkeydown='if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}'/></td>
                    </tr>

                <tr><td>Buyer:Date</td><td><input type="date" name="buyer"></td>
                <td>Seller:Date</td><td><input type="date" name="seller"></td></tr>


                <tr>
                    <td>建檔日期</td>
                      <td>  <input style="background:#F0F0F0;width:200px;" type="text" name="creatdate" value="<?php echo date("Y-m-d H:i:s");?>" readonly></td>
                    <td>建檔人員</td>
                    <td><input style="background:#F0F0F0;width:200px;" type="text" name="createmp" value="{{Session::get('name')}}" readonly></td>
                </tr>
                 <tr>
                    <td>最後修改日期</td>
