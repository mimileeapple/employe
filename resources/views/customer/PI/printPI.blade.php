...
@foreach($custhead as $data)
    ...
    <table class=" tbl" width="95%" style="font-size:6pt">
        <tr style="background:#305496;height: 25px;">
            <th colspan="2" style="text-align: left;margin: 3px;"><font color="white" style="margin: 5px;">BILL TO</font></th>
...
@endforeach
    ...
    <table class=" tbl" width="95%" style="margin: auto;font-size: 4px;">
        <tr>
            <td colspan="4" class="bg-black" style="text-align: left;font-size: 10px;"><font color="white">Terms and Condition</font> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            @if($payment>0)
                <table  class=" tbl" width="100%">
                    ...
                    <tr><td style="text-align: left;width: 70px;">{{$ment->payposit}}</td>
                        <td style="text-align: left;width:200px;">{{$ment->amount}}</td>
                        <td style="text-align: left;">{{$ment->method}}</td></tr>
                    @endforeach
        ...
        <tr>
            <td>3.Shipdate:</td>
            <td colspan="3" style="text-align: left;font-size: 10px;">{{$cust->shipdate}} 2) National Holidays or Local Custom Clearnace (both buyer and seller
                sides) might impact the delivery date 3) In case there is an unexpected event that could delay the production and/ or
                shipment, the Seller shall promptly notify the Buyer to determine a new delivery date.</td>
        </tr>
        <tr>
            <td>4. Warehouse fee:</td>
            <td colspan="3" style="text-align: left;">The Seller offers 7 days free of charge of warehouse costs. If the Buyer delays the shipment more than 7 days, the Buyer
                should pay USD $5 per pallet per day.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4" style="text-align: left;">
                <p style="font-size: 4pt;">
                    ...
                    4.The delivery time shall be in accordance with the Proforma Invoice and counted from the date of receipt of payment.<br>
                    5. The ownership of the goods and the deposit shall belong to the Sellers if the Buyer failss to complete the balance payment within 1 month after the due date of rest payment.<br>
                    6. The Buyer and the Seller shall resolve amicably all disputes. If the Buyer and Seller fail to settle disputes within 30 days, such disputes shall be referred to the Shenzhen Court of International Arbitration in People's Republic of China.<br>
                    7. The sellers shall not be held liable for failure or delay in delivery of the entire lot or a portion of the goods in consequence of any incidents.<br>
...
<table  class="" width="95%">
    <tr>
        ...
        <td><p style="color:#8EA9DB;font-size: 26px;margin-top:8px;text-align: left;"><b>All in One Specification</b></p></td>
    </tr>
</table>

<table class="" width="95%" style="text-align: left;" >
    @foreach($spacelist as $space)
        <tr><td><b style="font-size: 14px;width: 300px;">PI Number</b></td><td style="font-size: 10px;padding-left: 5px;">{{$space->pino}}</td></tr>
        <tr><td><b style="font-size: 14px;;width: 300px;">Date</b></td><td style="font-size: 10px;padding-left: 5px;">{{$space->orderdate}}</td></tr>
        ...
        @foreach($spacedata as $key=>$data)
            ...
            @if($key!=""&&$data!=""&&$key!=null&&$data!=null)
                ...
                <tr>
                    <td><b style="font-size: 14px;width: 300px;">
                        ...
                        @if($key=="Back IO"||$key=="Remark")
                            ...
                            @elseif($i>0)
                </tr><tr><td></td><td style="font-size: 10px;padding-left: 5px;"> {{$d[$word]}}</td></tr><tr>
                            @endif

                            @endforeach

                        @else
                     <td style="font-size: 10px;padding-left: 5px;">{{$data}}</td>
                        @endif
