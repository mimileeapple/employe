...
<br>
<form action="{{ route('payoffice.store') }}" method="post" name="form1">
    {{ csrf_field() }}
    <table border="1" class="tbl bor-blue" style="margin: auto;text-align: center;" width="95%">

        <tr><td class="bg-blue" >申請日期:</td>
            <td colspan="2" style="text-align: left;"><input type="text" name="orderdate" value="{{$today}}" style="width:380px;"></td>
            <td class="bg-blue">分類</td>
        ...
        <tr><td class="bg-blue">收款單位(戶名)</td>
            <td style="text-align: left;" colspan="2">
                <input type="text" name="accountname" style="width:380px;"
        ...
        <tr><td class="bg-blue">收款帳號</td><td colspan="4" style="text-align: left;">
                <input type="text" name="accountno" style="width:380px;"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}">
            </td></tr>
        <tr><td class="bg-blue">收款銀行</td><td  colspan="4" style="text-align: left;">
                <input type="text" name="accountbank" style="width:380px;"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}">
            </td></tr>
        <tr><td class="bg-blue">銀行代號</td><td colspan="4" style="text-align: left;">
                <input type="text" name="bankcode" style="width:380px;"
                       onkeydown="if(event.keyCode==13){event.keyCode=0;event.returnValue=false;}">
            </td></tr>
        <tr>
            ...
            <td colspan="4" style="text-align: left;">
               ...
               <input type="text" name="total" style="width:350px;"
        ...
        <tr><td class="bg-blue">建檔日期</td>
            <td><input style="background:#F0F0F0;" type="text" name="creatdate" value="{{$today}}" readonly ></td>
            <td class="bg-blue">申請人員</td>
            <td colspan="2"><input  style="background:#F0F0F0;" type="text" name="createmp" value="{{Session::get('name')}}" readonly ></td></tr>
