        ...
        <div class="col-md-10">
            <form action="{{route('personalinfor.update',$data->empid)}}" method="post">
                ...
                <table border="1" class="tbl" width="90%">
                    <tr><td class="bg-blue">密碼</td><td><input value="{{$data->pwd}}" type="text" name="pwd"></td>
                        <td class="bg-blue">手機</td><td><input value="{{$data->cellphone}}" type="text" name="cellphone"></td></tr>
                    <tr><td class="bg-blue">電話</td><td><input value="{{$data->phone}}" type="text" name="phone"></td>
                        <td class="bg-blue">地址</td><td><input value="{{$data->adress}}" type="text" name="adress" style="width:250px;"></td></tr>
                    <tr><td class="bg-blue">學歷</td><td><select  name="edu">
                        ...
                        <td class="bg-blue">職務代理人</td><td><select name="agentemp">
